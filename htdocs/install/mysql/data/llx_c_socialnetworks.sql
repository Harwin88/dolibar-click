...
INSERT INTO llx_c_socialnetworks (entity, code, label, url, icon, active) VALUES (1, 'mastodon', 'Mastodon', '{socialid}', 'fa-mastodon', 0);
...
INSERT INTO llx_c_socialnetworks (entity, code, label, url, icon, active) VALUES (1, 'pixelfed', 'Pixelfed', '{socialid}', 'fa-pixelfed', 0);
