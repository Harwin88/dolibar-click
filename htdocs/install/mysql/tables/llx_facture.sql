...
(
  ...
  close_missing_amount	double(24,8),							
  ...
  fk_input_reason       integer DEFAULT NULL,                   
  ...
  prorata_discount		real DEFAULT NULL,  					
  ...
  is_also_delivery_note tinyint DEFAULT 0 NOT NULL,             
