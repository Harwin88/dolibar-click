# Dolibarr Dockerizado

Este proyecto contiene la configuración necesaria para levantar Dolibarr (última versión) de forma local usando Docker y Docker Compose.
...
4. Accede a Dolibarr desde tu navegador en:
   
   [http://localhost:8080](http://localhost:8080)

## Instalación inicial de Dolibarr

Cuando accedas por primera vez, sigue el asistente de instalación web. Usa estos datos para la base de datos:

- **Servidor**: db
- **Usuario**: dolibarr
- **Contraseña**: dolibarr_pass
- **Base de datos**: dolibarr

## Estructura de archivos
- `Dockerfile`: Imagen personalizada basada en la oficial de Dolibarr.
- `docker-compose.yml`: Orquesta los servicios de Dolibarr y MariaDB.
- `htdocs/`: Carpeta de archivos de Dolibarr (persistente).
...
Para más información, visita la documentación oficial de Dolibarr: https://wiki.dolibarr.org/
# DOLIBARR ERP & CRM
